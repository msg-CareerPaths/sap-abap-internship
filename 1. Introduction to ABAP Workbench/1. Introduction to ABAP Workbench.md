...
- [1.8 Working with structures](#working-with-structures)
- [1.9 Using internal tables](#using-internal-tables)
- [1.10 Working with database tables](#working-with-database-tables)
- [1.11 ABAP Open SQL](#abap-open-sql)
- [1.12 Selection screen](#selection-screen)

## Optional Content
- [1.13 Extra: Autorization checks](#extra-autorization-checks)
- [1.14 Extra: Remote Function Calls and BAPIs](#extra-remote-function-calls-and-bapis)
