...
**Inmomplete ABAP Standard Types** do not contain a fixed length (incomplete). When they are used to define data objects, you therefore still need to specify the length of the variable.
**C**
